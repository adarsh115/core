...
class CustomerSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Customer
        fields = ['customer_name', 'id', 'expense_set', 'organization', 'billing_currency',
                  'individual', 'account', 'billing_address', 'banking_details', 'phone_1', 
                  'email', 'physical_address', 'customer_type']
